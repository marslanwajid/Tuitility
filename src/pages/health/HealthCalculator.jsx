...
const HealthCalculator = () => {
  const healthTools = [
    ...
    { name: 'DRI Calculator', desc: 'Calculate your Dietary Reference Intakes (DRI) including energy needs, macronutrient distribution, and vitamin/mineral requirements based on your personal profile with advanced options for pregnancy, lactation, and health conditions', url: '/health/calculators/dri-calculator', category: 'Nutrition', icon: 'fas fa-utensils' },
    { name: 'BRI Calculator', desc: 'Calculate your Body Roundness Index (BRI) with comprehensive body composition analysis, health risk assessment, and personalized recommendations based on advanced body shape metrics', url: '/health/calculators/bri-calculator', category: 'Fitness', icon: 'fas fa-circle-notch' }
  ]
