...
const FinanceCalculator = () => {
  const financeTools = [
    ...
    { name: 'Loan Calculator', desc: 'Calculate loan payments, interest, and amortization', url: '/finance/calculators/loan-calculator', category: 'Loans', icon: 'fas fa-hand-holding-usd' },
    { name: 'Currency Converter', desc: 'Convert between different currencies with real-time rates', url: '/finance/calculators/currency-calculator', category: 'Currency', icon: 'fas fa-exchange-alt' },
