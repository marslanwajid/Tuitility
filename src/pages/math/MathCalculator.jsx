...
const MathCalculator = () => {
  const mathTools = [
    ...
    { name: 'Comparing Decimals', desc: 'Compare decimals and find the greater or lesser value', url: '/math/calculators/comparing-decimals-calculator', category: 'Decimals', icon: 'fas fa-calculator' },
  ]
