...
const UtilityTools = () => {
  const utilityTools = [
    ...
    { name: 'OCR Tool', desc: 'Extract text from images (Coming Soon)', url: '#', category: 'Image Tools', icon: 'fas fa-file-alt' },
    { name: 'PDF to Image Converter', desc: 'Convert PDF pages to images (PNG/JPG)', url: '/utility-tools/converter-tools/pdf-to-image-converter', category: 'PDF Tools', icon: 'fas fa-file-image' },
