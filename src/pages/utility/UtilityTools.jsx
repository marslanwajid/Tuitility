...
const UtilityTools = () => {
  const utilityTools = [
    ...
    { name: 'RGB to Pantone', desc: 'Convert RGB to Pantone colors', url: '/utility-tools/converter-tools/rgb-to-pantone-converter', category: 'Converters', icon: 'fas fa-print' },
