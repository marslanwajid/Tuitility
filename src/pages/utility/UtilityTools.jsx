...
const UtilityTools = () => {
  const utilityTools = [
    { name: 'QR Code Generator', desc: 'Generate QR codes instantly', url: '/utility-tools/qr-code-generator', category: 'Generators', icon: 'fas fa-qrcode' },
    { name: 'Password Generator', desc: 'Create secure passwords', url: '/utility-tools/password-generator', category: 'Security', icon: 'fas fa-key' },
    { name: 'Word Counter', desc: 'Count words, characters, and paragraphs', url: '/utility-tools/word-counter', category: 'Text Tools', icon: 'fas fa-font' },
    { name: 'OCR PDF Generator', desc: 'Extract text from PDF documents using OCR', url: '/utility-tools/ocr-pdf-generator', category: 'PDF Tools', icon: 'fas fa-file-alt' },
    ...
    { name: 'Morse Code Translator', desc: 'Convert text to Morse code and decode', url: '/utility-tools/morse-code-translator', category: 'Converters', icon: 'fas fa-signal' },
    { name: 'HTML to Markdown', desc: 'Convert HTML markup to Markdown', url: '/utility-tools/html-to-markdown-converter', category: 'Converters', icon: 'fab fa-html5' },
