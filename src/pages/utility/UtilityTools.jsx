...
const UtilityTools = () => {
  const utilityTools = [
    ...
    { name: 'TikTok Downloader', desc: 'Download TikTok videos without watermark', url: '/converter-tools/tiktok-downloader', category: 'Social Media', icon: 'fab fa-tiktok' },
    ...
    { name: 'PDF Organizer', desc: 'Reorder and rearrange PDF pages', url: '/converter-tools/organize-pdf-pages', category: 'PDF Tools', icon: 'fas fa-sort-amount-down' },
    ...
    { name: 'English to IPA', desc: 'Convert text to phonetic notation', url: '/english-to-ipa-translator', category: 'Language', icon: 'fas fa-microphone-alt' },
    { name: 'Audio Bitrate Converter', desc: 'Convert audio between different bitrates', url: '/audio-bitrate-converter', category: 'Audio', icon: 'fas fa-music' },
    { name: 'QR Code Scanner', desc: 'Scan and decode QR codes instantly', url: '/converter-tools/qr-code-scanner', category: 'Utility', icon: 'fas fa-qrcode' },
    { name: 'QR Code Generator', desc: 'Scan and decode QR codes', url: '/qr-code-generator', category: 'Generators', icon: 'fas fa-search' },
    ...
    { name: 'Color Blindness Simulator', desc: 'Simulate color vision deficiencies', url: '/image-tools/color-blindness-simulator', category: 'Image Tools', icon: 'fas fa-eye' },
    { name: 'RGB to Pantone', desc: 'Convert RGB to Pantone colors', url: '/converter-tools/rgb-to-pantone-converter', category: 'Converters', icon: 'fas fa-palette' },
    { name: 'RGB to HEX Converter', desc: 'Convert RGB to HEX codes', url: '/converter-tools/rgb-to-hex-converter', category: 'Converters', icon: 'fas fa-palette' },
