...
const UtilityTools = () => {
  const utilityTools = [
    ...
    { name: 'Calories to Exercise', desc: 'Convert calories to exercise activities', url: '/converter-tools/calories-to-exercise-converter', category: 'Fitness', icon: 'fas fa-running' },
    { name: 'Audio Bitrate Converter', desc: 'Convert audio between different bitrates', url: '/converter-tools/audio-bitrate-converter', category: 'Audio', icon: 'fas fa-music' },
