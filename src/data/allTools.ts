export const allTools = [
  {
    ...
    desc: "Perform fraction operations with step-by-step arithmetic resolution and live circular pie slice or rectangular grid bar visualizers.",
  ...
  },
  {
    ...
    desc: "Calculate amortization schedules, monthly payments, and total interest over time",
    url: "/finance/calculators/amortization-calculator",
    category: "Finance",
    icon: "fas fa-table",
  },
  {
  ...
  },
  {
    ...
    desc: "Estimate calories burned from exercise, activity duration, and body weight",
    url: "/health/calculators/calorie-burn-calculator",
    category: "Health",
    icon: "fas fa-fire",
  },
  {
  ...
  },
  {
    ...
    url: "/knowledge/calculators/wpm-calculator",
    category: "Knowledge",
