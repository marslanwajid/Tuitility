...
const InsuranceCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, premium calculator, coverage, deductible`;
  const canonicalUrl = `https://tuitility.vercel.app/finance/calculators/insurance-calculator`;
