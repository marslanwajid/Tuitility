...
const TaxCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, income tax, federal tax, state tax`;
  const canonicalUrl = `https://tuitility.vercel.app/finance/calculators/tax-calculator`;
