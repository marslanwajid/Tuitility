...
const SalesTaxCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, vat, purchase price, tax rate`;
  const canonicalUrl = `https://tuitility.vercel.app/finance/calculators/sales-tax-calculator`;
