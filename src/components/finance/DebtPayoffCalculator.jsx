...
const DebtPayoffCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, debt elimination, snowball method, avalanche method`;
  const canonicalUrl = `https://tuitility.vercel.app/finance/calculators/debt-payoff-calculator`;
