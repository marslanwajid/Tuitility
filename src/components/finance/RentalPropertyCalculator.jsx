...
const RentalPropertyCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, real estate investment, cash flow, cap rate`;
  const canonicalUrl = `https://tuitility.vercel.app/finance/calculators/rental-property-calculator`;
