...
const FutureValueCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, fv, investment growth, time value of money`;
  const canonicalUrl = `https://tuitility.vercel.app/finance/calculators/future-value-calculator`;
