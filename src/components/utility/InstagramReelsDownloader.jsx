...
const InstagramReelsDownloader = () => {
    ...
    const seoData = {
        title: 'Instagram Reels Downloader - Download Reels HD | Tuitility',
        description: 'Free Instagram Reels downloader. Download high-quality Instagram Reels videos without watermarks. Fast, secure, and works on all devices.',
        keywords: 'instagram reels downloader, download instagram reels, instagram video downloader, reels saver, no watermark',
        canonicalUrl: 'https://tuitility.vercel.app/utility-tools/converter-tools/reels-downloader'
    };
