...
const ImageToWebP = () => {
  ...
  const seoData = {
    title: 'Image to WebP Converter - Compress Images Online | Tuitility',
    description: 'Free online Image to WebP converter. Compress JPG, PNG, GIF to WebP format for faster website loading. Batch conversion supported. 100% private.',
    keywords: 'image to webp, webp converter, image compression, jpg to webp, png to webp, batch image converter',
    canonicalUrl: 'https://tuitility.vercel.app/utility-tools/image-tools/image-to-webp-converter'
  }
