...
const CategoryNavigation = () => {
  ...
  const filterTabs = [
    { id: 'all', title: 'All Tools', icon: 'fas fa-th-large', color: '#8b5cf6' },
    { id: 'math', title: 'Math', icon: 'fas fa-calculator', color: '#3b82f6' },
    { id: 'finance', title: 'Finance', icon: 'fas fa-dollar-sign', color: '#10b981' },
    { id: 'science', title: 'Science', icon: 'fas fa-atom', color: '#f59e0b' },
    { id: 'health', title: 'Health', icon: 'fas fa-heartbeat', color: '#ec4899' },
    { id: 'utility', title: 'Utility', icon: 'fas fa-tools', color: '#8b5cf6' },
    { id: 'pdf', title: 'PDF', icon: 'fas fa-file-pdf', color: '#ef4444' },
    { id: 'knowledge', title: 'Knowledge', icon: 'fas fa-brain', color: '#f59e0b' }
  ]
  ...
  const allTools = [
    ...
    { name: 'Decimal to Fraction', desc: 'Convert decimals to fractions instantly', url: '/math/calculators/decimal-to-fraction-calculator', category: 'Math', icon: 'fas fa-arrows-alt-h' },
    { name: 'LCM Calculator', desc: 'Find least common multiple', url: '/math/calculators/lcm-calculator', category: 'Math', icon: 'fas fa-sort-numeric-up' },
    { name: 'Binary Calculator', desc: 'Convert and calculate binary numbers', url: '/math/calculators/binary-calculator', category: 'Math', icon: 'fas fa-1' },
    ...
    { name: 'Compare Decimals', desc: 'Compare multiple decimals', url: '/math/calculators/comparing-decimals-calculator', category: 'Math', icon: 'fas fa-balance-scale' },
    { name: 'Fraction to Percent', desc: 'Convert fractions to percentages', url: '/math/calculators/fraction-to-percent-calculator', category: 'Math', icon: 'fas fa-percentage' },
    ...
    { name: 'Laplace Calculator', desc: 'Calculate Laplace transform', url: '/math/calculators/laplace-calculator', category: 'Math', icon: 'fas fa-calculator' },
    
          { name: 'Mortgage Calculator', desc: 'Calculate monthly mortgage payments with taxes, insurance, PMI', url: '/finance/calculators/mortgage-calculator', category: 'Finance', icon: 'fas fa-home' },
    ...
    { name: 'Word Counter', desc: 'Count words, characters, and paragraphs', url: '/utility-tools/converter-tools/word-counter', category: 'Utility', icon: 'fas fa-font' },
    { name: 'Text to Speech', desc: 'Convert text to audio', url: '/utility-tools/converter-tools/text-to-speech-converter', category: 'Utility', icon: 'fas fa-volume-up' },
    { name: 'OCR Tool', desc: 'Extract text from images', url: '/utility-tools/image-tools/ocr', category: 'Utility', icon: 'fas fa-file-alt' },
    ...
    { name: 'Gen Z Translator', desc: 'Translate modern slang and expressions', url: '/utility-tools/converter-tools/genz-translator', category: 'Utility', icon: 'fas fa-language' },
    { name: 'English to IPA', desc: 'Convert text to phonetic notation', url: '/utility-tools/converter-tools/english-to-ipa-translator', category: 'Utility', icon: 'fas fa-microphone-alt' },
    { name: 'Calories to Exercise', desc: 'Convert calories to exercise activities', url: '/utility-tools/converter-tools/calories-to-exercise-converter', category: 'Utility', icon: 'fas fa-running' },
    { name: 'Audio Bitrate Converter', desc: 'Convert audio between different bitrates', url: '/utility-tools/converter-tools/audio-bitrate-converter', category: 'Utility', icon: 'fas fa-music' },
    { name: 'Instagram Reels Downloader', desc: 'Download Instagram Reels videos', url: '/utility-tools/converter-tools/reels-downloader', category: 'Utility', icon: 'fab fa-instagram' },
    { name: 'QR Code Scanner', desc: 'Scan and decode QR codes', url: '/utility-tools/converter-tools/qr-code-scanner', category: 'Utility', icon: 'fas fa-search' },
    { name: 'RGB to Pantone', desc: 'Convert RGB to Pantone colors', url: '/utility-tools/converter-tools/rgb-to-pantone-converter', category: 'Utility', icon: 'fas fa-swatches' },
    { name: 'Gold Weight Converter', desc: 'Convert precious metal weights', url: '/utility-tools/converter-tools/gold-precious-metal-weight-converter', category: 'Utility', icon: 'fas fa-coins' },
    ...
    { name: 'Career Assessment Calculator', desc: 'Calculate your career assessment', url: '/knowledge/calculators/career-assessment-calculator', category: 'Knowledge', icon: 'fas fa-briefcase' },
    { name: 'Trauma Assessment Calculator', desc: 'Calculate your trauma assessment', url: '/knowledge/calculators/trauma-assessment-calculator', category: 'Knowledge', icon: 'fas fa-brain' },
    { name: 'Anxiety Assessment Calculator', desc: 'Calculate your anxiety assessment', url: '/knowledge/calculators/anxiety-assessment-calculator', category: 'Knowledge', icon: 'fas fa-heart' },
