...
const PopularTools = () => {
  const popularTools = [
    ...
    { name: 'SSE Calculator', desc: 'Calculate Sum of Squared Errors for statistical analysis', url: '/math/calculators/sse-calculator', category: 'Math', icon: 'fas fa-chart-line', rating: 4.6, usage: '28K+' },
    { name: 'Currency Calculator', desc: 'Convert between 170+ world currencies with real-time rates', url: '/finance/currency-calculator', category: 'Finance', icon: 'fas fa-exchange-alt', rating: 4.8, usage: '45K+' },
    { name: 'Loan Calculator', desc: 'Calculate loan payments, interest, and amortization schedules', url: '/finance/loan-calculator', category: 'Finance', icon: 'fas fa-hand-holding-usd', rating: 4.7, usage: '35K+' },
    { name: 'Mortgage Calculator', desc: 'Calculate monthly mortgage payments with detailed breakdowns', url: '/finance/mortgage-calculator', category: 'Finance', icon: 'fas fa-home', rating: 4.8, usage: '42K+' },
