...
const PopularTools = () => {
  const popularTools = [
    ...
    { name: 'PDF to Image Converter', desc: 'Convert PDF pages to images (PNG/JPG/WebP)', url: '/utility-tools/converter-tools/pdf-to-image-converter', category: 'Utility', icon: 'fas fa-file-image', rating: 4.9, usage: '60K+' },
    ...
    { name: 'PDF Organizer', desc: 'Reorder PDF pages visually', url: '/utility-tools/converter-tools/organize-pdf-pages', category: 'Utility', icon: 'fas fa-sort-amount-down', rating: 4.9, usage: '15K+' },
