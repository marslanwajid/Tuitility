...
const PopularTools = () => {
  const popularTools = [
    ...
    { name: 'Percent to Fraction', desc: 'Convert percentages to simplified fractions', url: '/math/calculators/percent-to-fraction-calculator', category: 'Math', icon: 'fas fa-percentage', rating: 4.7, usage: '38K+' },
        ...
        { name: 'DBm Milliwatts Calculator', desc: 'Convert between dBm and milliwatts for precise RF power measurements', url: '/science/calculators/dbm-milliwatts-calculator', category: 'Science', icon: 'fas fa-bolt', rating: 4.6, usage: '18K+' },
