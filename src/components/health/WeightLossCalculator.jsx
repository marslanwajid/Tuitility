...
const WeightLossCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, weight loss plan, calorie deficit, macronutrients for weight loss, sustainable weight loss`;
  const canonicalUrl = `https://tuitility.vercel.app/health/calculators/weight-loss-calculator`;
