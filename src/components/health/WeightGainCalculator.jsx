...
const WeightGainCalculator = () => {
  ...
  const seoKeywords = `${toolData.name.toLowerCase()}, ${toolData.category.toLowerCase()} calculator, weight gain plan, calorie surplus, macronutrients for weight gain, healthy weight gain`;
  const canonicalUrl = `https://tuitility.vercel.app/health/calculators/weight-gain-calculator`;
