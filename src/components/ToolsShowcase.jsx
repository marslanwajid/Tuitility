...
const ToolsShowcase = () => {
  const featuredTools = [
    ...
    { name: 'Loan Calculator', desc: 'Calculate loan payments, interest, and amortization schedules', url: '/finance/loan-calculator', category: 'Finance', icon: 'fas fa-hand-holding-usd' },
    { name: 'Mortgage Calculator', desc: 'Calculate monthly mortgage payments with detailed breakdowns', url: '/finance/mortgage-calculator', category: 'Finance', icon: 'fas fa-home' },
